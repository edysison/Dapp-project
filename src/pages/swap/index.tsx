...
export const Popular = () => {
    const [WalletButtonShow,] = useAtom(WalletButtonShowState)
    const [_openWalletListState, SetOpenWalletListState] = useAtom(WalletListShowState)
    const [_selectTokenTail, setSelectTokenTail] = useAtom(Select_TokenTail)
    const [_selectTokenTop, setSelectTokenTop] = useAtom(Select_TokenTop)
    const [swapTokenTop, _setSwapTokenTop] = useAtom(SwapTokenTop)
    const [swapTokenTail, _setSwapTokenTail] = useAtom(SwapTokenTail)
